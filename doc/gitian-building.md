...
*Setup instructions for a Gitian build of Ai the coins using a Debian VM or physical system.*
...
- [Building Ai the coins](#building-bitcoin-core)
...
To build Ai the coins (for Linux, OS X and Windows) just follow the steps under 'perform
