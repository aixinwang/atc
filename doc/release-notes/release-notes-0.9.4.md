Ai the coins version 0.9.4 is now available from:
...
Ai the coins released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Ai the coins

upgrade to Ai the coins 0.9.4, which includes a workaround, **before** updating
OpenSSL.
