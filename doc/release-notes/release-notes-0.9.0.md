Ai the coins version 0.9.0 is now available from:
...
Rebranding to Ai the coins
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to Ai the coins.
...
0.1mATC per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mATC per kilobyte
