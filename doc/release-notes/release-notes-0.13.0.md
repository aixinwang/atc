Ai the coins version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of Ai the coins
...
Various code modernizations have been done. The Ai the coins code base has
...
HD wallets are incompatible with older versions of Ai the coins.
...
proposed parameters, a future release of Ai the coins is expected that
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use ATC/kB (MarcoFalke)
